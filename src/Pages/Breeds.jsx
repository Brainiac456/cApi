...
const Breeds = () => {
        ...
        const getBreed = async(event)=>{
          ...
          axios.get((`https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=`+event.target.value) , { 'headers': { 'x-api-key': 'live_2om4LCa9Cj0PuUxGU1Ylr3tvEUFtP56pqOxC1j8BA4qiCefv6iq8IsAIUlhPTJgr' } })
          .then((response) => {
...
<label className="lable">Breed</label>
        <select className="dropdown-content" name='Breed' onClick={getBreed}>
        {
        breed?.map(breed =>{  
